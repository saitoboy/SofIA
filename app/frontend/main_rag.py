...
from app.models.rag_chain_builder import ask_sofia_with_rag
from app.models.context_loader import load_context_from_csv, load_context_from_pdf, load_default_pdf_context

# Configuração inicial do Streamlit
st.set_page_config(page_title="Sofia com RAG", layout="wide")
...
# TÍTULO PRINCIPAL
st.title("📚 Sofia com RAG")
st.write("Converse com a assistente baseada em documentos carregados via Pinecone.")
...
if combined_context:
    ...
    if prompt:
        ...
        with st.spinner("Sofia está pensando com RAG..."):
            try:
                response = ask_sofia_with_rag(prompt)
